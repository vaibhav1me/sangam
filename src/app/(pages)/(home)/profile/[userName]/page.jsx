  ...
  return (
    ...
    <div>
      <div id='profile' className='mt-10 flex justify-around min-w-[500px] max-w-[55rem] w-[100%] m-auto px-4 mb-10'>
        ...
        <Image src={user?.profilePhoto ? user.profilePhoto : avatar} alt='profile' height={16} width={16} className='h-[8rem] w-[8rem] rounded-full border-[2px] border-primary-600'/>
        </div>

...
const NavMenu = () => {
  ...
  return (
    <nav className="max-w-[300px] bg-dark-3 rounded-tr-xl rounded-br-xl min-w-[180px] w-[20%] h-screen flex flex-col justify-between p-2 px-5 overflow-y-scroll">
      <div id="logo" className="mt-3 mb-10">
        <p className="m-auto text-center text-[2rem] w-[100%] max-w-[11rem] font-bold font-mono italic rounded-md px-3">Sangama</p>
